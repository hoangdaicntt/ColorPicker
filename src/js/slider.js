...
var COLORSLIDER_POS_LIMIT_RANGETOP = [-7, 115];
var COLORSLIDER_POS_LIMIT_RANGE = [-7, 312];
...
Slider.prototype._moveColorSliderHandle = function (newLeft, newTop, silent) {
    ...
    newTop = Math.max(COLORSLIDER_POS_LIMIT_RANGETOP[0], newTop);
    newTop = Math.min(COLORSLIDER_POS_LIMIT_RANGETOP[1], newTop);
...
Slider.prototype.moveSaturationAndValue = function (saturation, value, silent) {
    var absMin, maxValue, absMinTop, maxValueTop, newLeft, newTop;
    ...
    absMinTop = Math.abs(COLORSLIDER_POS_LIMIT_RANGETOP[0]);
    maxValueTop = COLORSLIDER_POS_LIMIT_RANGETOP[1];
    ...
    newTop = maxValueTop - (value * maxValueTop) / 100 - absMinTop;
...
Slider.prototype.getSaturationAndValue = function () {
    var absMin = Math.abs(COLORSLIDER_POS_LIMIT_RANGETOP[0]);
    var maxValue = absMin + COLORSLIDER_POS_LIMIT_RANGETOP[1];
